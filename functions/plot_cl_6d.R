## Plot KF data from command line. format:
# Rscript --vanilla functions/plot_kf_6d.R "filename" true
...
if (tolower(args[2]) == "true") {
  plot_kf_6d(filename=args[1],png=TRUE)
} else {
  plot_kf_6d(filename=args[1],png=FALSE)
}
