...
plot_with_track(filename=fname,png=TRUE,plot_hdg=TRUE)
```
...
p_tl <- cowplot::plot_grid(p_t, legend, ncol=2, rel_widths=c(2,1))
# right side will be track+legend above yaw+yaw_rate
p_rt <- cowplot::plot_grid(p_tl,pb,ncol=1,rel_heights=c(2,1))
# make overall plot
p_tot <- cowplot::plot_grid(pq2,p_rt,ncol=2,rel_widths=c(3,2))
