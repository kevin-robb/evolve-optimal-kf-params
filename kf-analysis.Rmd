...
plot_with_track(filename=fname,png=FALSE)
```
...
p_t <- ggplot(df_t) + geom_line(aes(x_meas,y_meas,colour="red")) +
  geom_line(aes(x_pred,y_pred,colour="blue")) +
  geom_line(aes(x,y,colour="green")) +
  geom_line(aes(x_true,y_true,colour="black")) +
